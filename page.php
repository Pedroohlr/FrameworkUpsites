    ...
    <section class="py-16 md:py-20 bg-white">
      <div class="container mx-auto px-4">
        <article id="page-<?php the_ID(); ?>" <?php post_class('max-w-4xl mx-auto'); ?>>
          ...
          <div
            class="prose prose-lg max-w-none prose-headings:text-framework-black prose-p:text-gray-700 prose-a:text-grid-primary prose-strong:text-framework-black prose-img:rounded-xl">
            <?php the_content(); ?>
          </div>
