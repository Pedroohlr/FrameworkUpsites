    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div class="flex items-center gap-4">
          <img src="<?php echo GRIDTHEME_URI; ?>/assets/img/icone-grid.svg" alt="Grid Icon"
        ...
        <div class="lg:col-span-3">
                ...
                <article
                  ...
                  <?php else: ?>
                    <a href="<?php the_permalink(); ?>"
                      class="block bg-framework-primary/10 h-48 flex items-center justify-center">
                      <img src="<?php echo GRIDTHEME_URI; ?>/assets/img/icone-grid.svg" alt="Grid Icon"
                  ...
                  <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-framework-black mb-3 line-clamp-2">
                      <a href="<?php the_permalink(); ?>"
                        class="hover:text-framework-primary transition-colors duration-200">
                        <?php the_title(); ?>
                      </a>
                    </h2>
          ...
          <?php else: ?>
            ...
            <div class="text-center py-16">
              <img src="<?php echo GRIDTHEME_URI; ?>/assets/img/icone-grid.svg" alt="Grid Icon"
                class="w-20 h-20 mx-auto mb-6 opacity-50">
              ...
              <a href="<?php echo esc_url(home_url('/')); ?>"
                class="cta-button bg-framework-primary text-white px-6 py-3 rounded-full font-semibold inline-flex items-center gap-3">
                Voltar para Home
