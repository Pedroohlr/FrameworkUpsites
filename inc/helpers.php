 ...
 */
function frameworkupsites_format_phone($phone)
{
  if (empty($phone))
    return '';
 ...
 */
function frameworkupsites_whatsapp_link($number = '', $message = '')
{
  if (empty($number)) {
    $number = frameworkupsites_get_whatsapp();
  }
 ...
 */
function frameworkupsites_get_responsive_image($image_id, $size = 'full', $class = '')
{
  if (!$image_id)
    return '';
 ...
 */
function frameworkupsites_limit_text($text, $limit = 100, $ending = '...')
{
 ...
 */
function frameworkupsites_limit_words($text, $limit = 20, $ending = '...')
{
  $words = explode(' ', $text);
 ...
 */
function frameworkupsites_reading_time($content = '')
{
  if (empty($content)) {
 ...
 */
function frameworkupsites_is_mobile()
{
  return wp_is_mobile();
}
 ...
 */
function frameworkupsites_youtube_embed($video_id, $autoplay = false)
{
 ...
 */
function frameworkupsites_vimeo_embed($video_id, $autoplay = false)
{
 ...
 */
function frameworkupsites_format_price($price)
{
 ...
 */
function frameworkupsites_sanitize_title($title)
{
 ...
 */
function frameworkupsites_get_first_paragraph($content = '')
{
  if (empty($content)) {
    $content = get_the_content();
  }
 ...
 */
function frameworkupsites_get_contrast_color($hex)
{
  // Remove o # se existir
  $hex = str_replace('#', '', $hex);
 ...
 */
function frameworkupsites_is_external_url($url)
{
 ...
 */
function frameworkupsites_external_link_attributes($url, $text = '')
{
  if (frameworkupsites_is_external_url($url)) {
 ...
 * Breadcrumbs
 */
function frameworkupsites_breadcrumbs()
{
  global $post;
 ...
 */
function frameworkupsites_social_share($title = 'Compartilhar:', $show_label = true)
{
