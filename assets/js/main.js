...
(function() {
    ...
    function initStickyHeader() {
        ...
        function updateHeader() {
            ...
            if (servicosSection) {
                ...
                isOverServicos = servicosRect.top <= headerHeight && servicosRect.bottom > 0;
            }
    ...
    function initBackToTop() {
        ...
        if (!backToTopBtn) {
            ...
            backToTopBtn.className = 'fixed bottom-8 right-8 bg-blue-600 text-white w-12 h-12 rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 opacity-0 pointer-events-none z-50';
            backToTopBtn.innerHTML = '<svg class="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>';
